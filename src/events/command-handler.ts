...
export class CommandHandler implements EventHandler {
    ...
    public async process(intr: Interaction): Promise<void> {
        // Check if interaction is chat input
    ...
    private async sendError(intr: Interaction, data: EventData): Promise<void> {
        try {
